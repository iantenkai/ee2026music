...
entity Audio_Output is
    Port ( 
     ...
     --SIGNALS PROVIDED TO Audio_Output
       CLK      : in std_logic;    -- System Clock (50MHz)     
       START    : in std_logic;    -- Sampling clock 20kHz
       DATA1    : in std_logic_vector(11 downto 0);   -- 12-bit digital data1
       DATA2    : in std_logic_vector(11 downto 0);   -- 12-bit digital data2
       RST      : in std_logic;  --1'b0x`
     
     --Pmod interface signals
       D1       : out std_logic;    -- PmodDA2 Pin2 (Serial data1)
       D2       : out std_logic;    -- PmodDA2 Pin3 (Serial data2)
       CLK_OUT  : out std_logic;    -- PmodDA2 Pin4 (Serial Clock)
       nSYNC    : out std_logic;    -- PmodDA2 Pin1 (Chip Select)
       DONE     : out std_logic
              
        );
end Audio_Output ;

architecture DA2 of Audio_Output is
